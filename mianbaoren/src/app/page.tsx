...
export default function Home() {
  ...
  const links: LinkItem[] = [
    {
      ...
      rating: 5,
      desc: "排序法的免费荣格八维测试，型式新颖。虽然只有70道题，但其实是为了降低理解成本进行了场景融合，280个选项还是很丰富的。内容说人话，不故弄玄虚，报告详细免费。体验优秀，可以登录保存结果，也可以免登录查看结果，推荐。"
    },
    {
      title: "Pdb类型数据库(非测试)",
    ...
    },
    {
      ...
      rating: 4,
      desc: "专业度较高的荣格八维测试。题目略显晦涩，是两功能迫选，可能会碰到两者皆否但无法表达的情况。测试和初步报告免费，深度报告收费。需要登录才能测试。",
    },
    {
      title: "荣格斯 荣格心里测试",
  ...
  return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-indigo-900 flex items-center justify-center p-4 font-sans">
        {/* 卡片容器 */}
        <div className="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden p-8 md:p-12 transform transition-all duration-500 hover:shadow-2xl">
          {/* 标题部分 */}
                ...
                >
                  <div className="flex items-center w-full justify-between">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-800 dark:text-gray-200 font-medium group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-300">
                    {link.title}
                  </span>
                    </div>
                    <span className="text-indigo-500 dark:text-indigo-400 transform transition-transform duration-300 group-hover:translate-x-1">
          ...
          <div className="mt-12 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <p>© 2025 mianbao.ren - 仅代表个人观点，仅供学习参考。</p>
          </div>
        </div>
      </div>
  );
